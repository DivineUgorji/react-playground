  ...
  return (
    <section className="bg-gradient-to-top">
      <div className="m-auto flex max-w-[90rem] flex-col items-center px-24 py-32 max-xl:px-16 max-xl:py-24 max-lg:px-8">
        <div className="max-lg:p-y-0 mb-20 flex max-w-[51.625rem] flex-col items-center gap-y-6 max-lg:mb-18 max-lg:gap-y-0">
        ...
        >
          ...
          <CaretUp
            className={`stroke-primary-50 group-hover:stroke-primary-1300 ${expanded && "rotate-360"} rotate-180 transition-all duration-300`}
            alt="caret icon"
            width={2}
          />
        </button>
